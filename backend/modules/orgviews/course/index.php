...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\Course $searchModel
*/
        ...
        'columns' => [
			...
			[
			                ...
			                'value' => function ($model) {
			                    return \backend\modules\org\models\Course::getRegulationValueLabel($model->regulation);
			                }    
			            ],
			'title',
			'descript',
