...
/**
* PurchaseInfoSearch represents the model behind the search form about `\backend\modules\org\models\PurchaseInfo`.
*/
class PurchaseInfoSearch extends PurchaseInfo
{
/**
* @inheritdoc
*/
