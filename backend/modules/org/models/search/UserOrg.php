...
use backend\modules\org\models\UserOrg as UserOrgModel;

/**
* UserOrg represents the model behind the search form about `\backend\modules\org\models\UserOrg`.
*/
class UserOrg extends UserOrgModel
{
/**
* @inheritdoc
*/
