...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\UserAddressSearch $searchModel
*/

$this->title = Yii::t('backend', 'User Addresses');
...
?>
<div class="giiant-crud user-address-index">
        ...
        'columns' => [
			...
			[
			                ...
			                'value' => function ($model) {
			                    return \backend\modules\org\models\UserAddress::getGenderValueLabel($model->gender);
			                }    
			            ],
			'country',
			'province',
