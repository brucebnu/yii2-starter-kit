...
$this->params['breadcrumbs'][] = ['label' => Yii::t('backend', 'User Address'), 'url' => ['index']];
...
<div class="giiant-crud user-address-update">
    <div class="clearfix crud-navigation">
        <div class="float-left">
            <?= Html::a('<span class="fa fa-eye"></span> ' . Yii::t('backend', 'View'), ['view', 'user_address_id' => $model->user_address_id], ['class' => 'btn btn-block btn-outline-success btn-sm']) ?>
        </div>
    </div>
    <hr />
