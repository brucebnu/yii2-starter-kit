...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\UserToAgencySearch $searchModel
*/

$this->title = Yii::t('backend', 'User To Agencies');
...
?>
<div class="giiant-crud user-to-agency-index">
