...
?>
<div class="giiant-crud user-to-org-view">
    <!-- flash message -->
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='float-left'>
            ...
            [ 'update', 'user_to_ort_id' => $model->user_to_ort_id],
            ['class' => 'btn btn-info']) ?>

            <?= Html::a(
            '<i class="fa fa-copy"></i> ' . Yii::t('backend', 'Copy'),
            ['create', 'user_to_ort_id' => $model->user_to_ort_id, 'UserToOrg'=>$copyParams],
    ...
    <?php $this->beginBlock('\backend\modules\org\models\UserToOrg'); ?>
    ...
    'attributes' => [
        ...
        'user_id',
            [
                'attribute'=>'role_name',
                'value'=>\backend\modules\org\models\UserToOrg::getRoleNameValueLabel($model->role_name),
            ],
            [
                'attribute'=>'status',
                'value'=>\backend\modules\org\models\UserToOrg::getStatusValueLabel($model->status),
            ],
        'org_title',
    ],
    ]); ?>
    ...
    <?= Html::a('<i class="fa fa-trash"></i> ' . Yii::t('backend', 'Delete'), ['delete', 'user_to_ort_id' => $model->user_to_ort_id],
    [
...
<div style='position:absolute; right: 0px; top: -25px;'>
  ...
  <?= Html::a(
            ...
            ['organization/create', 'Organization' => ['org_id' => $model->user_to_ort_id]],
...
<div style='position:absolute; right: 0px; top: -25px;'>
  ...
  <?= Html::a(
            ...
            ['user-org/create', 'UserOrg' => ['user_id' => $model->user_to_ort_id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div>
</div>
...
<?php $this->endBlock() ?>
    ...
    <?= yii\bootstrap4\Tabs::widget(
         [
             ...
             'items' => [
 [
    'label'   => '<b class=""># '.Html::encode($model->user_to_ort_id).'</b>',
    'content' => $this->blocks['\backend\modules\org\models\UserToOrg'],
    'active'  => true,
],
[
