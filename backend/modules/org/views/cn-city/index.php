...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\CnCitySearch $searchModel
*/

$this->title = Yii::t('backend', 'Cn Cities');
...
?>
<div class="giiant-crud cn-city-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
            ...
            \yii\bootstrap4\ButtonDropdown::widget([
                ...
                'items' => [
            [
                'url' => ['cn-province/index'],
                'label' => '<i class="fa fa-arrow-left"></i> ' . Yii::t('backend', 'Cn Province'),
            ],
                                [
                'url' => ['cn-region/index'],
                'label' => '<i class="fa fa-arrow-right"></i> ' . Yii::t('backend', 'Cn Region'),
            ],
