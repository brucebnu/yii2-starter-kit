...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\CnRegionSearch $searchModel
*/

$this->title = Yii::t('backend', 'Cn Regions');
...
?>
<div class="giiant-crud cn-region-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
            ...
            [
                'url' => ['cn-city/index'],
                'label' => '<i class="fa fa-arrow-left"></i> ' . Yii::t('backend', 'Cn City'),
            ],
                                [
                'url' => ['cn-town/index'],
                'label' => '<i class="fa fa-arrow-right"></i> ' . Yii::t('backend', 'Cn Town'),
            ],
                                [
                'url' => ['cn-zipcode/index'],
                'label' => '<i class="fa fa-arrow-right"></i> ' . Yii::t('backend', 'Cn Zipcode'),
            ],
