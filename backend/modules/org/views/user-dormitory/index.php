...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\UserDormitorySearch $searchModel
*/

$this->title = Yii::t('backend', 'User Dormitories');
...
?>
<div class="giiant-crud user-dormitory-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
            ...
            [
                'url' => ['dormitory/index'],
                'label' => '<i class="fa fa-arrow-left"></i> ' . Yii::t('backend', 'Dormitory'),
            ],
                                [
