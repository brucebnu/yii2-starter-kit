...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\UserFileStorageSearch $searchModel
*/

$this->title = Yii::t('backend', 'User File Storages');
...
?>
<div class="giiant-crud user-file-storage-index">
