...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\CnZipcodeSearch $searchModel
*/

$this->title = Yii::t('backend', 'Cn Zipcodes');
...
?>
<div class="giiant-crud cn-zipcode-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
            ...
            [
                'url' => ['cn-region/index'],
                'label' => '<i class="fa fa-arrow-left"></i> ' . Yii::t('backend', 'Cn Region'),
            ],
