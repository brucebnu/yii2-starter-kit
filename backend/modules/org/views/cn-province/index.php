...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\CnProvinceSearch $searchModel
*/

$this->title = Yii::t('backend', 'Cn Provinces');
...
?>
<div class="giiant-crud cn-province-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            [
                'url' => ['cn-city/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('backend', 'Cn City'),
            ],
