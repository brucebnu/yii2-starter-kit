...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\modules\org\models\search\UserExpressSearch $searchModel
*/

$this->title = Yii::t('backend', 'User Expresses');
...
?>
<div class="giiant-crud user-express-index">
...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="clearfix crud-navigation">
            ...
            [
                ...
                'label' => '<i class="fa fa-arrow-left"></i> ' . Yii::t('backend', 'User Address'),
            ],
                                [
                'url' => ['user-org/index'],
        ...
        'columns' => [
			...
			[
			                ...
			                'value' => function ($model) {
			                    return \backend\modules\org\models\UserExpress::getExpressTypeValueLabel($model->express_type);
			                }    
			            ],
			'express_title',
			'express_no',
